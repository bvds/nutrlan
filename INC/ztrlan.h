...
*/
typedef void (*ztrl_matvec) (int *pnrow, int *pncol, trl_dcomplex *x, int *pldx,
...
*/
typedef void (*ztrl_matvec) (const int nrow, const int ncol,
			     const trl_dcomplex *x, const int ldx,
			     trl_dcomplex *y, const int ldy, void *mvparam);
#endif
